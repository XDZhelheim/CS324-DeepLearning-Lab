...
def main(args):
    ...
    if args.dataset.lower() == "moon":
        x, y = make_moons(points, random_state=SEED)
    elif args.dataset.lower() == "circle":
        x, y = make_circles(points, random_state=SEED)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="moon",
        help=
        "Choose dataset. \"moon\" for make_moons(), \"circle\" for make_circles()."
    )
